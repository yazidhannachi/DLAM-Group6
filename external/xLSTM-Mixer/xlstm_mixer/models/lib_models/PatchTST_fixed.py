...
class PatchTST(BaseModel):
    ...
    def __init__(self, enc_in, task_name="long_term_forecast", seq_len=96,d_model=512,pred_len=96,dropout=0.1, patch_len=16, stride=8,d_ff=2048, e_layers=2, n_heads=4, factor=3, activation='gelu'):
        """
