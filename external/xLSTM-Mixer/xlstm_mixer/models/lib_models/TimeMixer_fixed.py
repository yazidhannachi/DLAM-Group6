...
class TimeMixer(BaseModel):
    ...
    def __init__(
        ...
        self.c_out = enc_in if channel_independence else 1
        self.enc_in = enc_in
        ...
        self.pdm_blocks = nn.ModuleList(
            [PastDecomposableMixing(self) for _ in range(self.e_layers)]
        )
    ...
    def anomaly_detection(self, x_enc):
        ...
        dec_out = (
            dec_out.reshape(B, self.c_out, -1).permute(0, 2, 1).contiguous()
        )
