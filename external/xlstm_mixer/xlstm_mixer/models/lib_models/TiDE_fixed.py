...
class TiDE(BaseModel):  
    ...
    """
    def __init__(self, task_name="long_term_forecast",enc_in=21, seq_len=96,label_len=0,pred_len=96,d_model=512,e_layers=2,d_layers=2,freq="m",d_ff=512,dropout=0.3, bias=True): 
        ...
        self.freq=freq
        self.feature_encode_dim=1
        self.decode_dim = enc_in
